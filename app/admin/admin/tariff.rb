ActiveAdmin.register Tariff do
  ...
  permit_params :waiting_price, :price_per_kilometer, :percentage_of_driver, :free_waiting_minutes,
                ...
                :driver_rate_increase_by_photo, :min_order_amount, :name, :position, :priority, :max_commission,
                :night_price_per_kilometer
  ...
  form do |f|
    f.inputs do
      ...
      f.input :night_price_per_kilometer
