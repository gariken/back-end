ActiveAdmin.register User, namespace: :senior_dispatcher do
  ...
  action_item only: :show do
    link_to 'Удалить фото', "/senior_dispatcher/users/#{user.id}/remove_photo", method: :put, data: { confirm: 'Вы уверены, что хотите удалить фото?' }
  end
